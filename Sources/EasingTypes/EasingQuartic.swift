...
public struct EasingQuartic {
    ...
    /// Provides a quartic easing equation applied to the beginning of a motion.
    ...
    /// Provides a quartic easing equation applied to the end of a motion.
    /// - Returns: Returns a closure containing the easing equation.
    ...
    /// Provides a quartic easing equation applied to the beginning and end of a motion.
    /// - Returns: Returns a closure containing the easing equation.
    public static func easeInOut() -> EasingUpdateClosure {
        ...
        func easing (_ elapsedTime: TimeInterval, startValue: Double, valueRange: Double, duration: TimeInterval) -> Double {
            ...
            if (time < 1) {
                easing_value = (valueRange * 0.5) * time*time*time*time + startValue
                
            } else {
                time -= 2
                easing_value = (-valueRange * 0.5) * (time*time*time*time - 2) + startValue
            }
