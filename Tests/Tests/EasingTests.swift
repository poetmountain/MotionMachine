...
class EasingTests: XCTestCase {
    ...
    func test_easing_linear() {
        ...
        let mid = easing(elapsedTime: 50, startValue: 0, valueRange: 100, duration: 100)
        let end = easing(elapsedTime: 100, startValue: 0, valueRange: 100, duration: 100)
    ...
    func test_easing_quadratic() {
        ...
        let mid_in = ease_in(elapsedTime: 50, startValue: 0, valueRange: 100, duration: 100)
        let end_in = ease_in(elapsedTime: 100, startValue: 0, valueRange: 100, duration: 100)
        ...
        let mid_out = ease_out(elapsedTime: 50, startValue: 0, valueRange: 100, duration: 100)
        let end_out = ease_out(elapsedTime: 100, startValue: 0, valueRange: 100, duration: 100)
        ...
        let mid_inout = ease_inout(elapsedTime: 50, startValue: 0, valueRange: 100, duration: 100)
        let end_inout = ease_inout(elapsedTime: 100, startValue: 0, valueRange: 100, duration: 100)
